...
class CustomExpansionTile extends StatefulWidget {
  ...
  const CustomExpansionTile({
    ...
    this.iconColor,
    this.collapsedIconColor, this.expandedBackgroundColor,
          ...
          ListTileTheme.merge(
            ...
            child: InkWell(
              ...
              widget.trailing ?? RotationTransition(
                        turns: _iconTurns,
                      child:  Icon(Icons.expand_more,color: widget.expandedArrowColor??Colors.white)),
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: closed ? null : Container(
         color: widget.expandedBackgroundColor??Colors.black,
